...
class HomeScreen extends StatelessWidget {
  ...
  BottomNavigationBar _bottomNavigationBar() => BottomNavigationBar(
    ...
    items: menus
    .map((e) => BottomNavigationBarItem(icon: Icon(e), label: e.toString()))
    .toList(),
  ...
  Container _doctor(DoctorModel doctorModel) {
    return Container(
              ...
              boxShadow: [BoxShadow(color: Color(0xFF35385A).withOpacity(.12),
                blurRadius: 30, offset: Offset(0, 2))]
              ),
              child: Row(children: [
                Container(
                  ...
                  child: Image.asset('assets/images/${doctorModel.picture}',
                  height: 103,
                  width: 88,
                  ),
                ),
                ...
                Flexible(
                  ...
                  child: Column(
                    ...
                    children: [Text(doctorModel.name, 
    ...
    return SizedBox(
              ...
              child: ListView.separated(
                ...
                itemBuilder: (context, index) => Container(
                  ...
                  decoration: BoxDecoration(color: selectedService == index 
                  ...
                  child: Center(child: Text(Service.all()[index], 
    ...
    return AspectRatio(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                child: Stack(
                  children: [
                    Image.asset('assets/images/background_card.png',
                      ...
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                          children: [ RichText(
                              ...
                              height: 150 / 100),     
                              children: [ const TextSpan(text: " Catrine ", 
                              style: TextStyle(
                              color: Colors.white,
                ...
                children: [
                  ...
                  Positioned(
                    ...
                    child: Container(
                      height: 15,
                      width: 15,
                      decoration: BoxDecoration(color: Color(0xFFEF6497),
                      borderRadius: BorderRadius.circular(15/2)),
                      child: Center(child: Text('2', style: GoogleFonts.mPlus1(
                        color: Colors.white, 
